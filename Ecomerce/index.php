...
<body>
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg navbar-light bg-info  4px gray  fixed-top">
      ...
      cart();
        ?>
        <br> <br> <br>
        <nav class="navbar navbar-expand-lg navbar-dark bg-secondary d-flex ">
            <ul class="navbar-nav me-auto d-flex ">
                ...
                ?>
                <li class="nav-item justify-content-end align-itmes-end text-end">
                 <a class="nav-link text-end justify-content-end align-itmes-end" href="./admin/admin_login.php">Admin login <i class="fa-solid fa-user-lock"></i></a>
                 </li>
        ...
        <div class="bg-light">
            ...
            <p class="text-center">
                Loremi, ipsum dolor sit , dolores pariatur dolorum mollitia quae at suscipit.
            </p>
        </div>
        <div class="row">
            <div class="col-md-10">
            ...
            <div class="col-md-2 bg-secondary p-0">
                <ul class="navbar-nav me-auto">
                    <!-- <li class="nav-item bg-info">
                        <a href="#" class="nav-link text-center text-light"> <h4>Delivary brands</h4></a>
                    </li>
                    <li class="nav-item ">
                        <a href="#" class="nav-link text-center text-light"> Brands</a>
                    </li>
                    <li class="nav-item ">
                        <a href="#" class="nav-link text-center text-light"> Brands</a>
                    </li>
